...
public class TestSeUsoAlgunPresupuestoRequerido {
    ...
    private OperacionEgreso opEgTest = new OperacionEgreso(usuarioTest,50000,docComTest,articulosTest,mdpTest,presReqTest,1,condicionesTest1);

    private BandejaDeMensajes bdm = new BandejaDeMensajes();

    public TestSeUsoAlgunPresupuestoRequerido() throws VerificadorException {
    }


    @Test
    public  void realizarVerificacionUsoPresupuestoRequerido() throws ValidadorTransparenciaException {
