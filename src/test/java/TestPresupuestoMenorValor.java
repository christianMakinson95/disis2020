...
public class TestPresupuestoMenorValor {
    ...
    private OperacionEgreso opEgTest = new OperacionEgreso(usuarioTest,20000,docComTest,articulosTest,mdpTest,presReqTest,1,condicionesTest3);
    private BandejaDeMensajes bdm = new BandejaDeMensajes();

    public TestPresupuestoMenorValor() throws VerificadorException {
    }

    @Test
    public  void realizarVerificacionPrespuestoMenorValor() throws ValidadorTransparenciaException {
